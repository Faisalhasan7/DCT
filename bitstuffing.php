...
<head>
    ...
    <title>Bit Stuffing/De-stuffing</title>
    <style>
        body {
            ...
            <div class="row justify-content-center"">
                <div class="card" style="width: 100%; max-width: 600px;">
                    <h5 class="card-header"
                        ...
                        Bit Stuffing and Destuffing</h5>
                    <hr>
                    <div class="card-body ">
                        <form action="" method="post">
                            ...
                            <button type="submit" name="bitStuff">Bit Stuffing</button>
                            <button class="btn-success" type="submit" name="bitDestuff">Bit Destuffing</button>
                        </form>
                    </div>
                    <?php
                function bitStuffing($data, $flag) {
                    // Implement Bit Stuffing here

                    // Find occurrences of flag in data and insert '0' after each occurrence
                    $stuffedData = str_replace($flag, $flag . '0', $data);

                    return $stuffedData;
                }

                function bitDestuffing($data, $flag) {
                    // Implement Bit Destuffing here

                    // Remove '0' after each occurrence of flag in data
                    $destuffedData = str_replace($flag . '0', $flag, $data);
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    if (isset($_POST['bitStuff'])) {
                        $stuffedData = bitStuffing($inputData, $flag);
                        echo "<div id='result'>Bit Stuffed Data: $stuffedData</div>";
                    }

                    if (isset($_POST['bitDestuff'])) {
                        $destuffedData = bitDestuffing($inputData, $flag);
                        echo "<div id='result'>Bit Destuffed Data: $destuffedData</div>";
                    }
                }
                ?>
                    <br>
